    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['user_id_mod'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
              ...
              // Cifrar la contraseña del usuario con la función password_hash() de PHP 5.5 genera una cadena hash de 60 caracteres.
              //  La constante PASSWORD_DEFAULT está definida por PHP 5.5 o, 
              // si se utiliza PHP 5.3/5.4, por la biblioteca de compatibilidad de hash de contraseñas.
