    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $letra = mysqli_real_escape_string($con,(strip_tags($_POST["letra"],ENT_QUOTES)));
                ...
                if ($query_check_user == 1) {
                    $errors[] = "Lo sentimos , el nombre de usuario o la dirección de correo electrónico ya estan en uso.";
                } else {
					// write new user's data into database
                    $sql = "INSERT INTO users (nombre, user_name, user_password_hash, user_email, letra, date_added,is_admin)
                            VALUES('".$firstname."','" .$user_name. "', '" .$user_password_hash. "', '" .$user_email. "', '" .$letra. "','".$date_added."','".$is_admin."');";
